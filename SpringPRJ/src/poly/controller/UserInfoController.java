...
public class UserInfoController {
	...
	public String getUserLoginCheck(HttpSession session, HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			 ...
			 * 
			 * 		무조건 웹으로 받은 정보는 DTO 에 저장하기 위해 임시로 String 변수에 저장함
			 * ####################################################
			 * */
			...
			* ####################################################
			 ...
			 * 세션은 톰캣(was)의 메모리에 존재하며, 웹사이트에 접속한 사람(연결된 객체)
			 * 마다 메모리에 값을 올린다.
			 * 예 ) 톰캣에 100명의 사용자가 로그인 했다면, 사용자 각각의 회원아이디를 메모리에 저장하며,
			 ...
			 * 세션은 톰켓의 메모리에 저장되기 때문에 url 마다 전달하는 게 필요하지 않고,
			 ...
			 * 숫자 유형의 데이터 타입은 값을 전달하고 받는 데 불편함이 있어
