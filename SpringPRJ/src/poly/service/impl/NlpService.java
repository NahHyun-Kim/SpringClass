...
public class NlpService implements INlpService{
	...
	//NLP_DIC를 ㄱㄴㄷㄹ 순으로 나눠서 저장한 이유는 전체 약 몇만건의 데이터를 조회하는
	//것보다 일정한 범위를 지정하여 데이터조회 횟수를 감소시키기 위해서 나눔
	 ...
	 * 
	 * 데이터 사전 변수 생성을 위한 함수 최초 스프링 호출이 발생할때 함수가 실행 실행 이후 더이상 실행하지 않는다.
	 * 
	 * NLP_DIC 변수에 값을 저장함.
	 */
	@Override
